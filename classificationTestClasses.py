...
def readDigitData(trainingSize=100, testSize=100):
    ...
    rawTestData = samples.loadDataFile(rootdata + "testimages", testSize,DIGIT_DATUM_WIDTH,DIGIT_DATUM_HEIGHT)
    testLabels = samples.loadLabelsFile(rootdata + "testlabels", testSize)
    try:
